...
public class ShowBus extends JFrame {
    ...
    public void items() {
        ...
        // Column identifiers 
        String[] columns = { "Bus Number", "Driver Name", "Driver Id"}; 
        ...
        rightpanel.add(img);
        JLabel adt = Element.getLabel("Bus List ", 400, 10,  200, 30);
