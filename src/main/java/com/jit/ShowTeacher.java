...
public class ShowTeacher extends JFrame {
    ...
    public void items() {
        ...
        // Column identifiers 
        String[] columns = { "Id", "Name", "Age", "Gender", "Subject", "Mobile Number", "Email" }; 
        ...
        try {
            ...
            while(rs.next()){
                Object[] rowData = {rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8)};
                dtm.addRow(rowData);
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        rightpanel.add(img);
        JLabel adt = Element.getLabel("Teacher List ", 400, 10, 200, 30);
